...
-- Ensure mechanic_profiles table has all necessary fields
ALTER TABLE mechanic_profiles ADD COLUMN IF NOT EXISTS user_id UUID REFERENCES auth.users(id);
ALTER TABLE mechanic_profiles ADD COLUMN IF NOT EXISTS name TEXT;
ALTER TABLE mechanic_profiles ADD COLUMN IF NOT EXISTS email TEXT;
ALTER TABLE mechanic_profiles ADD COLUMN IF NOT EXISTS phone TEXT;
ALTER TABLE mechanic_profiles ADD COLUMN IF NOT EXISTS avatar_url TEXT;
ALTER TABLE mechanic_profiles ADD COLUMN IF NOT EXISTS bio TEXT;
ALTER TABLE mechanic_profiles ADD COLUMN IF NOT EXISTS specialties TEXT[] DEFAULT '{}';
ALTER TABLE mechanic_profiles ADD COLUMN IF NOT EXISTS experience TEXT;
ALTER TABLE mechanic_profiles ADD COLUMN IF NOT EXISTS rating DECIMAL;
ALTER TABLE mechanic_profiles ADD COLUMN IF NOT EXISTS review_count INTEGER DEFAULT 0;
ALTER TABLE mechanic_profiles ADD COLUMN IF NOT EXISTS created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW();
ALTER TABLE mechanic_profiles ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW();
