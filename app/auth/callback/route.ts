          ...
          if (redirect === 'post-appointment') {
            ...
            if (existingUser) {
              ...
              if (existingUser.onboarding_completed) {
                ...
                console.log('⏳ User has incomplete onboarding in users table, continuing to post-appointment flow');
              }
            } else {
              console.log('📝 No existing user record found, continuing to post-appointment flow');
            }
